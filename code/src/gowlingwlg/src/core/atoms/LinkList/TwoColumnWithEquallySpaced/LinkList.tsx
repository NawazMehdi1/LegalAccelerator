...
const LinkList = (props: LinkListProps) => {
  ...
  return (
    <div className={styles} id={id ? id : undefined}>
      <div className="component-content md:pl-[0.875rem] md:pt-[0.875rem] pt-[0.5rem]">
        <Text
          tag="h4"
        ...
        <ul
          ...
          className="TwoColumnWithEquallySpaced grid md:grid-cols-2 md:gap-x-[1.25rem] md:gap-y-[1.563rem] gap-y-[0.938rem]"
        >
          {datasource?.children?.results
            ...
            .map((element: ResultsFieldLink, index: number) => (
              <li
                key={`${index}-link-list`}
                className="md:text-black hover:font-bold text-white leading-[156%]"
              >
