...
try {
    ...
    & $mkcert -install
    & $mkcert "*.gowlingwlg.localhost"
    & $mkcert "gwlg.xmcloudcm.localhost"
...
Add-HostsEntry "gwlg.xmcloudcm.localhost"
Add-HostsEntry "www.gowlingwlg.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "gwlg.xmcloudcm.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.gowlingwlg.localhost"
