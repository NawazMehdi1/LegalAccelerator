...
export type DataItem = string | DataRow;

export type jCardProperty = DataItem[];

type DataRow = {
  [key: stirng]: string | string[];
};
...
export declare module vcf {}

export function fromJSON(data: jCard): vCard.Property;
