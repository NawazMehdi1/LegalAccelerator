 ...
 */
const PersonalizePageView = (): JSX.Element => {
  const {
  ...
  const createPageView = async (
    ...
    const engage = await init({
      clientKey: 'gow7h2u7ct69soc9n8c3456fxmzllgse',
      ...
      pointOfSale: 'home',
      //cookieDomain: '*.gowling-wlg.vercel.app',
    ...
    //To test whether script is loading or not.
    console.log('CDP script is calling');
  };
...
export default PersonalizePageView;
